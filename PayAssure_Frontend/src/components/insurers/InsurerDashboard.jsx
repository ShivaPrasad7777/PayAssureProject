...
const IMAGE_URLS = {
  ...
  summaryPolicies: "https://imgs.search.brave.com/nZvfGp0ShlLqGJb7nVmqmENNFiC4mR7pV_p8ZAMSeY0/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly90aHVt/YnMuZHJlYW1zdGlt/ZS5jb20vYi9saWZl/LWluc3VyYW5jZS1j/b25jZXB0LWZhbWls/eS1maW5hbmNlLWhl/YWx0aC1zaGllbGQt/aWNvbi1yZXByZXNl/bnRzLXByb3RlY3Rp/bmctd2hhdC1kZWFy/LTM1MDgzMjk2OC5q/cGc",
...
export default function InsurerDashboard({ user }) {
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      {/* Consistent, Large-picture Stat Cards */}
        ...
        <Grid item xs={12} sm={6} md={4} display="flex" justifyContent="center">
          ...
          >
            ...
            >
              ...
              >
                <PolicyIcon sx={{ fontSize: 32, color: "#fff" }} />
              </Avatar>
            </Box>
            <CardContent sx={{ textAlign: "center", pt: 2 }}>
              <Typography variant="h4" sx={{ color: "#1976d2", fontWeight: 700, mb: 1 }}>
      ...
      <Box mt={8} mb={8}>
        ...
        {allInvoices.length === 0 ? (
          ...
          allInvoices.slice(0, 6).map((invoice, idx) => (
            ...
            >
              <Avatar sx={{ bgcolor: invoice.status === 'UNPAID' || invoice.status === 'FAILED' ? "#e53935" : "#1976d2", width: 62, height: 62, mr: 3 }}>
                {(invoice.status === 'UNPAID' || invoice.status === 'FAILED') ? (
                  <WarningAmberIcon sx={{ fontSize: 36, color: "#fff" }} />
                ) : (
                  <AssignmentTurnedInIcon sx={{ fontSize: 36, color: "#fff" }} />
                )}
              </Avatar>
              <Box flex={1}>
                <Typography variant="h6" fontWeight={700}>
                ...
                <Typography variant="body1" sx={{ fontWeight: 600, color: invoice.status === 'UNPAID' || invoice.status === 'FAILED' ? theme.palette.error.dark : theme.palette.success.dark }}>
